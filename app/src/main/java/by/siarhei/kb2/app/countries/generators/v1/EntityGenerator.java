...
public class EntityGenerator {
    ...
    private final MapPoint[][] map; //pointer to Country's map
...
//    private final ArrayList<Castle> castles = new ArrayList<>();
    ...
    public EntityGenerator(Country country) {
    ...
    private void cities() {
        ...
        while (count < 5) {
            ...
            if (((map[x + 1][y].getLand() == R.drawable.water)
                ...
                country.getCitiesVar().add(createCity(map[x][y], country.getCastlesVar().get(count)));
                count++;
            }
        }
    }
